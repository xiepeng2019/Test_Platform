    ...
    setup: () => {
      ...
      Mock.mock(new RegExp('/api/user/userInfo'), () => {
        return Mock.mock({
          name: 'admin',
          avatar:
            'https://s1-imfile.feishucdn.com/static-resource/v1/v2_f1843f38-c4b3-468f-9dd7-2fc94a8fb48g~?image_size=noop&cut_type=&quality=&format=image&sticker_format=.webp',
