...
export const routes: IRoute[] = [
  ...
  },
  {
    ...
    children: [
      {
        name: 'menu.test.testCase',
        key: 'chipTest/cases',
      },
      {
        name: 'menu.test.testPlan',
        key: 'chipTest/plans',
      },
      {
        name: 'menu.test.testTask',
        key: 'chipTest/tasks',
      },
      {
        name: 'menu.test.taskConfig',
        key: 'chipTest/taskConfig',
      }
    ],
  },
  {
    ...
    children: [
      {
        name: 'menu.resourceManagement.server',
        key: 'resourceManagement/server',
      }
    ],
  },
  // {
